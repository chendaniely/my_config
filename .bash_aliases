...
alias nsfr='cd ~/git/columbia/projects-nsf-gershon/Data\ analysis/scripts/R'

alias mann='cd ~/git/multi-agent-neural-network && source activate mann'
alias mdme='cd ~/git/multidisciplinary-diffusion-model-experiments/src && source activate mann'
...
#   fi) '$BYellow$PathShort$IYellow' ⟫ '$Color_Off' "; \
# else \
#   # @2 - Prompt when not in GIT repo
#   echo " '$IYellow$PathShort$IYellow' ⟫ '$Color_Off'"; \
# fi)'
